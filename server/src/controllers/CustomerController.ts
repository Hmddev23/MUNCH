...
export const CustomerSignUp = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if(existingCustomer !== null) {
    return res.status(400).json({
      'message': 'A user exist with the provided email'
    });
  }
  ...
  return res.status(400).json({
    'message': 'Error with the Signup, cant create the user'
  });
}
...
export const CustomerLogin = async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.json({
    'message': 'Error with the Login, cant find the user'
  });
}
...
export const CustomerVerify = async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(400).json({
    'message': 'Unable to verify Customer / Error with OTP Validation'
  });
}
...
export const GetCustomerProfile = async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(400).json({
    'message': 'Error, Cant Fetch the Customer Profile'
  });
}
...
export const EditCustomerProfile = async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(400).json({
    'message': 'Cant Update the Customer Profile!'
  });
}
...
export const DeleteCart = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if(customer) {
    const profile = await Customer.findById(
      customer._id
    ).populate('cart.food').exec();
...
export const CreateOrder = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if(customer) {
    ...
    if(!status) {
      return res.status(404).json({
        'message': 'Error with Validating transaction!'
      });
    }
...
export const CreatePayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(400).json({
    'message': 'Cant create a payment transaction'
  });
}
